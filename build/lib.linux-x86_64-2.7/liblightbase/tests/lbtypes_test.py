...
class lbtypes_test(unittest.TestCase):
    def test_string_init_value(self):
        ...
        self.assertEqual(lbtypes.String(u'test_unicode').value ,u'test_unicode')
    ...
    def test_string_set_and_get(self):
        ...
        test_string.value = u'test_unicode'
        self.assertEqual(test_string.value ,u'test_unicode')
    ...
    def test_integer_init_value(self):
        ...
        self.assertRaises(ValueError,lbtypes.Integer,u'test')
    ...
    def test_float_init_value(self):
        ...
        self.assertRaises(ValueError,lbtypes.Float,u'test')
